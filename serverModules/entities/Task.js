...
class Task {
    ...
    constructor(data) {
        ...
        // note: the entries are NOT cumulative, i.e., every entry has to contain the entire text that should be displayed after the given delay (not only an additional sentence)
